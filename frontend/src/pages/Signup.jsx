      ...
      <div className="max-w-md w-full mx-auto border border-gray-300 rounded-2xl p-8">
        <div className="text-center mb-12">
          <a href="javascript:void(0)"><img
            src="https://img.icons8.com/?size=100&id=68067&format=png&color=000000" alt="logo" className='w-40 inline-block' />
          </a>
        </div>
        ...
        <form>
          <div className="space-y-6">
            <div>
              ...
              <input name="text" type="text" className="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-3 rounded-md outline-blue-500" placeholder="Enter email" />
            </div>
            <div>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="remember-me" className="text-gray-800 ml-3 block text-sm">
                I accept the <a href="https://paytm.com/company/terms-and-conditions?company=one97&tab=terms" target="blank" className="text-blue-600 font-semibold hover:underline ml-1">Terms and Conditions</a>
              </label>
            </div>
          </div>
